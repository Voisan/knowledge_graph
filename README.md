...
Учебный Python-проект для курсовой работы на тему: **"Сравнительный анализ методов построения графов научных знаний с использованием эмбеддингов и больших языковых моделей"**.
